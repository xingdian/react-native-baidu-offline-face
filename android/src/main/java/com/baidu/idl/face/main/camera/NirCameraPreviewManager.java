...
import com.tracy.baidu.face.Main;
 ...
 * Description:
 */
public class NirCameraPreviewManager implements TextureView.SurfaceTextureListener {
    ...
    private static volatile NirCameraPreviewManager instance = null;
    ...
    public static NirCameraPreviewManager getInstance() {
        synchronized (NirCameraPreviewManager.class) {
            if (instance == null) {
                instance = new NirCameraPreviewManager();
            }
        }
        return instance;
    }
    ...
    private void openCamera() {
        ...
        try {
            if (mCamera == null) {
                ...
                cameraId = Main.getInstance().nirCameraIndex;
                if (cameraId >= num) {
                    return;
                }
            ...
            if (cameraRotation == 90 || cameraRotation == 270) {
                int isRgbRevert = SingleBaseConfig.getBaseConfig().getMirrorNIR();
                if (isRgbRevert == 1) {
