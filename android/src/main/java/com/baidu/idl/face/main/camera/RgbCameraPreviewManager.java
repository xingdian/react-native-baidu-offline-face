 ...
 * Description:
 */
public class RgbCameraPreviewManager implements TextureView.SurfaceTextureListener {
    ...
    private static volatile RgbCameraPreviewManager instance = null;
    ...
    public static RgbCameraPreviewManager getInstance() {
        synchronized (RgbCameraPreviewManager.class) {
            if (instance == null) {
                instance = new RgbCameraPreviewManager();
            }
        }
        return instance;
    }
    ...
    private void openCamera() {
        ...
        try {
            if (mCamera == null) {
                ...
                cameraId = Main.getInstance().rgbCameraIndex;
                if (cameraId >= num) {
                    return;
                }
